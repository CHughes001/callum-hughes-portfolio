        ...
        <div className="min-w-0">
          ...
          <div className="max-w-[760px] space-y-8 font-['Inter',sans-serif] text-[1rem] leading-[1.78] text-[var(--body-text)] max-[640px]:text-[0.95rem]">
            ...
            <p className="m-0 text-pretty">
              ...
              — building data pipelines, analysing market data, and creating
              dashboards that make complex information easier to understand.
            </p>
            ...
            <p className="m-0 text-pretty">
              ...
              to explore system prices, balancing dynamics, renewable generation,
              and wider market behaviour. I’m particularly interested in the
              commercial side of the energy transition and the role data plays in
            ...
            <p className="m-0 text-pretty">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[var(--accent-link)] underline-offset-4 transition-colors duration-200 hover:underline"
              >
                LinkedIn profile
              </a>
              .
          ...
          <div className="mt-14 w-full border-t border-[var(--line-soft)] pt-10">
            ...
            <h2 className="m-0 font-['Cormorant_Garamond',serif] text-2xl font-semibold tracking-tight text-[var(--primary-title)] max-[640px]:text-[1.85rem]">
              Skills
            </h2>
            

            <div className="mt-8 grid gap-10 min-[900px]:grid-cols-3">
              
            {SKILL_GROUPS.map((group) => (
  <div key={group.title}>

    {/* SUBHEADING (make it feel like a section title) */}
    <h4 className="m-0 font-['Cormorant_Garamond',serif] text-[1.4rem] font-semibold tracking-tight text-[var(--primary-title)]">
      {group.title}
    </h4>

    <ul className="mt-6 m-0 list-none space-y-4 p-0">

      {group.items.map((item) => (
        <li
          key={item}
          className="relative pl-5 text-[1.05rem] leading-relaxed text-[var(--body-text)] before:absolute before:left-0 before:top-[0.75em] before:h-1.5 before:w-1.5 before:rounded-full before:bg-[var(--accent-link)] before:content-['']"
        >
          {item}
        </li>
      ))}
